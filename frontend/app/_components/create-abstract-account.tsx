...
import {useCreateAccountMonarchy, useAccounts, useModules} from "@abstract-money/react"
...
export const CreateAbstractAccount: React.FC = () => {
  ...
  // Do a query of the pop contract
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <Button onClick={installPop}>Install pop</Button>
      </CardContent>
    </Card>
  )
}
