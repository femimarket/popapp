...
export class PopAppQueryClient implements IPopAppQueryClient {
  ...
  queryTrade = async (params: CamelCasedProperties<Extract<QueryMsg, {
    query_trade: unknown;
  }>["query_trade"]>): Promise<TradeResponse> => {
...
export interface IPopAppClient extends IPopAppQueryClient {
  ...
  trade: (params: CamelCasedProperties<Extract<ExecuteMsg, {
    trade: unknown;
  }>["trade"]>, fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<ExecuteResult>;
...
export class PopAppClient extends PopAppQueryClient implements IPopAppClient {
  ...
  trade = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    trade: unknown;
  }>["trade"]>, fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<ExecuteResult> => {
    return this._execute(PopExecuteMsgBuilder.trade(params), fee_, memo_, funds_);
  };
  tradeCiphertext = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    trade_ciphertext: unknown;
